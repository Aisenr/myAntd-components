    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          positionPoint.length > 0 && _react2.default.createElement(_reactAmap.Marker, { position: { lng: positionPoint[0], lat: positionPoint[1] } }),
          linePoints.length > 0 && _react2.default.createElement(_reactAmap.Polyline, { path: linePoints }),
          pathPoints.length > 0 && _react2.default.createElement(_reactAmap.Polygon, {
            style: { strokeColor: 'red', fillColor: 'gray', fillOpacity: 0.3, strokeStyle: 'dashed' },
            path: pathPoints
          })
        )
      );
