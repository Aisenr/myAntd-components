...
var GeoMap = function (_React$PureComponent) {
  (0, _inherits3.default)(GeoMap, _React$PureComponent);

  function GeoMap() {
    (0, _classCallCheck3.default)(this, GeoMap);
    return (0, _possibleConstructorReturn3.default)(this, (GeoMap.__proto__ || (0, _getPrototypeOf2.default)(GeoMap)).apply(this, arguments));
  }
