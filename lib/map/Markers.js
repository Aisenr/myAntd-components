...
var Markers = (_temp = _class = function (_React$PureComponent) {
  ...
  function Markers(props) {
    ...
    _this.tooltipFunc = function (param) {
      var markers = param.data.markers;

      if (markers && markers.length > 1) {
        var names = markers.map(function (marker) {
          return marker.name;
    ...
    _this.symbolSizeFunc = function (value, param) {
    ...
    _this.state = { data: data, inBoundsData: [] };
    return _this;
  }
  ...
  (0, _createClass3.default)(Markers, [{
    ...
    value: function changeBounds() {
      ...
      var extendedBounds = (0, _cluster.getExtendedBounds)(this.map, mapBounds, this.props.clusterGridSize);
      this.setState({
    ...
    value: function setOptions() {
      var _props = this.props,
          ...
          symbolRotate = _props.symbolRotate,
          symbolOffset = _props.symbolOffset,
