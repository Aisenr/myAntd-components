  ...
  render() {
    return (
      <div style={{ width: '1000px', fontSize: '16px', margin: '40px auto' }}>
        <SelectArea selectPoint={[116.404, 39.915]} value={this.state.value} onChange={this.handleChange} dataType="geo" />
        初始状态：<SelectArea dataType="geo" onChange={this.handleChange1} />
      </div>
    );
  }
}
